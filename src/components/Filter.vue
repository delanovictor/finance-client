<template>
    <div class="w-full grid md:grid-cols-9   grid-cols-6  m-1 p-2   ">
        ...
        <div class="md:col-span-8  col-span-4">
            <input
                class="w-full text-gray-100 p-1 rounded-l-md bg-gray-900 border-gray-800 border-2"
                type="text"
        ...
        <div
            class="md:col-span-1  col-span-1 w-1/2 self-center py-2 px-1 cursor-pointer bg-gray-900 hover:bg-gray-800 border-gray-800  border-t-2 border-b-2 border-r-2 rounded-r-2xl   "
            @click="toggleFilter"
        >
            <img
        ...
        <Transition name="filter">
            <div
                v-if="filterActive"
                class="md:col-span-8  col-span-4 grid md:grid-cols-9   grid-cols-6 bg-gray-800 pt-3 pb-3 pl-5 rounded-b-2xl border-gray-800  border-l-2 border-b-2 border-r-2"
            >
